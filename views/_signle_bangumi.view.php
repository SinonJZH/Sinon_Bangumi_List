<a href="<?php echo (esc_url($saved_bangumi[$id]['url'])); ?>" target="_blank" class="bangumItem" title="<?php echo (esc_attr($saved_bangumi[$id]['title'])); ?>">
    ...
    <div class="textBox"><?php echo (esc_attr($saved_bangumi[$id]['name_cn'])); ?>
        ...
        <div class="jinduBG">
            <div class="jinduText">
                <?php if ($saved_bangumi[$id]['times'] != null && $saved_bangumi[$id]['times'] > 1) :  //仅在周目大于1时显示周目
            ...
            <div class="jinduFG" style="width:<?php echo (esc_attr((string) ((float) $saved_bangumi[$id]['progress'] / $saved_bangumi[$id]['count'] * 100))); ?>%;">
            </div>
        ...
        <div class="jinduFG" style="width:100%;">
        </div>
    <?php endif ?>
    </div>
    </div>
